...
if (isset($_GET['id'])) {
    ...
    // Fetch order details
    $orderQuery = $conn->prepare("SELECT * FROM order_details WHERE id = ?");
    ...
    $productQuery->execute([$orderData['productID']]);
...
<body>
    <div class="header">
        ...
        <div class="table-title">
            <div class="row">
                <div class="col-sm-4">
                    <h2>Order <b>Product</b> <b>Details</b></h2>
                </div>
                <div class="col-sm-8">
                        <a href="orders.php" class="btn btn-primary"><i
                                class="material-icons">&#xE5C8;</i> <span>Back To Orders List</span></a>
                </div>
            </div>
        </div>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <tr>
                    <td><?php echo $productData['carID']; ?></td>
                    <td><?php echo $productData['carName']; ?></p></td>
                    <td><?php echo $productData['carPrice']; ?></p></td>
                    <td><?php echo $productData['carCity']; ?></p></td>
                    <td><?php echo $productData['carModel']; ?></td>
                    <td><?php echo $productData['carMilage']; ?></td>
                    <td><?php echo $productData['carFuel']; ?></td>
                    <td><?php echo $productData['carCc']; ?></td>
                    <td><?php echo $productData['carTransmission']; ?></td>
                    <td><?php echo $productData['carUpdatetime']; ?></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <!-- <p>Product Name: <?php echo $productData['carName']; ?></p>
    <table border=1>
        <tr>
            <td>ID</td>
            <td>Car Name</td>
        ...
        <tr>
            <td><?php echo $productData['carID']; ?></td>
            <td><?php echo $productData['carName']; ?></td>
            <td><?php echo $productData['carPrice']; ?></td>
        </tr>
    </table> -->
